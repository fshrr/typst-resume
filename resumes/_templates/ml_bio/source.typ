...
#items(
  [Built a RAG chatbot for an immigration consultancy ingesting voice notes and OCR'd multilingual documents (50-60 docs/client across ~30 clients), cutting application prep from 2 hours to ~20 minutes.],
  [Developed a logging app turning patient voice logs into structured clinical data (region, type, severity) for physiotherapist pre-session review, cutting session time from 45 to 30 minutes and enabling more daily appointments.],
)
...
#project(
  name: "Computational Biology & Wiki Lead",
  group: "iGEM Toronto",
  dates: "May 2017 — Oct 2017",
)
#items(
  [Developed an iOS app for gold particle analysis and led protein structure optimization, contributing to a bronze medal at iGEM Jamboree 2016.],
  [Built a team wiki with D3.js and Jmol visualizations and a new brand guide, contributing to a bronze medal at iGEM Jamboree 2017.],
)
