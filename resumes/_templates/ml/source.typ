...
#items(
  ...
  [Designed a multipersona chatbot using Google ADK and prompt engineering to ground responses in source texts, with logging/observability and guardrails to catch unsafe outputs.],
)
